...
ICText1 = visual.TextStim(win=win, name='ICText1',
    text=' Now interacting with 3 other players ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
ICText2 = visual.TextStim(win=win, name='ICText2',
    text='One of you will be randomly assigned to start. The selected player will start the experiment first',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# Shock delivery replaced with space
...
for thisConditioningLoop in ConditioningLoop:
    ...
    # Change routine timer timing for black cross 1,2
    t = 0
    FixCrossClock.reset()  # clock
    frameN = -1
    continueRoutine = True
    routineTimer.add(15.50000)
    # update component parameters for each repeat
    # keep track of which components have finished
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *Cross* updates
        # change frame remains timing for black cross 2,2
        if t >= 0.0 and Cross.status == NOT_STARTED:
            ...
            print("Showing cross")
            #time.sleep(5)
        frameRemains =15 + 0.5- win.monitorFramePeriod * 0.75  # most of one frame period left
    ...
    continueRoutine = True
    # update component parameters for each repeat
    ImageFile = "images/" + faces_list[faceNumber] + ".BMP"
