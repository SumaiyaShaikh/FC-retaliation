...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\sumsh86\\Desktop\\aggression\\AggPrototypeConditioning phase 2.1.py',
...
WelcomeText = visual.TextStim(win=win, name='WelcomeText',
    text='Part 2: Start of the pairing experiment',
    font='Arial',
...
# Sumaiya Shaikh COMMENT This is where I need help to intiate voltage triggers from Psychopy
