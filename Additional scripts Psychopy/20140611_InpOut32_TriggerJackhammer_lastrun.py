...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy3 Experiment Builder (v1.80.03),
    on February 08, 2019, at 17:20
...
expName = '20140611_InpOut32_TriggerJackhammer'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\sumsh86\\Desktop\\aggression\\20140611_InpOut32_TriggerJackhammer_lastrun.py',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text.status == STARTED:  # only update if drawing
        text.setText(displayval, log=False)
    # *ISI* period
